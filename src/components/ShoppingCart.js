...
//   const calculateShippingCost = (governorate) => {
//     // This is a placeholder function. Replace with actual shipping costs for each governorate.
//     const shippingRates = {
//       PortSaid: 20, // داخل بور سعيد
//       Ismailia: 30, // إسماعيلية قريبة
//       Damietta: 30, // دمياط قريبة
//       Cairo: 50, // القاهرة
//       Giza: 60, // الجيزة أبعد قليلاً
//       Alexandria: 75, // الإسكندرية بعيدة
//       Dakahlia: 40, // الدقهلية قريبة نوعًا ما
//       Sharqia: 45, // الشرقية
//       Gharbia: 50, // الغربية
//       KafrElSheikh: 55, // كفر الشيخ
//       Monufia: 55, // المنوفية
//       Beheira: 65, // البحيرة
//       Qalyubia: 50, // القليوبية
//     };
//     return shippingRates[governorate] || 100; // Default to 100 if governorate not found
//   };
...
//           ).toFixed(
//             2
//           )}\n   🖼️ الصور: ${item.selectedImages.join(
//             ", "
//           )}`
//       )
//       .join("\n\n");
//     return `
// 🎉 طلب جديد من ${customerDetails.name} 🎉

// 💵 المبلغ الإجمالي: $${totalAmount.toFixed(2)}
// 🚚 تكلفة الشحن: $${shippingCost.toFixed(2)}
// 💰 الإجمالي مع الشحن: $${(
//       totalAmount + shippingCost
//     ).toFixed(2)}
...
// 📍 العنوان:
//    المحافظة: ${customerDetails.governorate}
//    المركز/المنطقة: ${customerDetails.centerArea}
//    الحي: ${customerDetails.neighborhood}
// 🔔 طريقة الاتصال المفضلة: ${
//       customerDetails.preferredContactMethod
//     }
// 🚚 تعليمات التوصيل: ${
//       customerDetails.deliveryInstructions
//     }
// 💬 رسالة إضافية: ${customerDetails.message}
...
//     ) {
//       case "whatsapp":
//         const whatsappUrl = `https://wa.me/201223821206?text=${encodeURIComponent(
//           message
//         )}`;
...
//         const emailUrl = `mailto:your-email@example.com?subject=${emailSubject}&body=${emailBody}`;
