...
export default function PanelsPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = modalMode === "add" ? "/api/panels" : `/api/panels/${selectedPanel._id}`;
        ...
        <div className="bg-gray-100 shadow-xl rounded-lg p-6 w-full mt-5">
            <div className="container mx-auto px-4 py-8 rtl text-right">
                <div className="flex justify-between mb-4">
                    <h1 className="text-3xl font-bold mr-0 text-gray-800">إدارة اللوحات</h1>
                    <button
                    ...
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white p-6 rounded shadow-lg w-96">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 mb-2 text-right">العنوان الفرعي</label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-4">
                                    <label className="block text-gray-700 mb-2 text-right">الصورة</label>
                                    <input
                                        type="file"
                                        accept="image/*"
                                        onChange={(e) => {
