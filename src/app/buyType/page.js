...
export default function BuyTypePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const url = modalMode === "add" ? "/api/buyType" : `/api/buyType/${selectedField._id}`;
        ...
        <div className="bg-gray-100 shadow-xl rounded-lg p-6 w-full mt-5">
            <div className="container mx-auto px-4 py-8 rtl text-right">
                <div className="flex justify-between mb-4">
                    <h1 className="text-3xl font-bold mr-0 text-gray-800">إدارة أنواع الدفع</h1>
                    <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {buyTypes.map((type) => (
                        <div key={type._id} className="bg-white border p-4 rounded shadow-lg hover:bg-gray-50">
