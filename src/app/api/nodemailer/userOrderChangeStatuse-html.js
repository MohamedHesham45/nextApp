        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p><strong>نوع التوصيل:</strong> ${customerDetails.shippingType}</p>
                    ...
                    <p><strong>الحالة:</strong><span style="color: #ff9900; font-weight: bold;"> ${statusText}</span></p>
                    <table>
                        <thead>
                            <tr>
                                <th>صورة</th>
...
export default generateOrderStatusChangeEmailUserTemplate;