function generateOrderEmailUserTemplate(orderData) {
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p><strong>الحالة:</strong><span style="color: #ff9900;"> ${statusText}</span></p>
                    <table>
                        <thead>
                            <tr>
                                <th>صورة</th>
...
export default generateOrderEmailUserTemplate;